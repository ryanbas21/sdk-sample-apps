...
await forgerock.Config.setAsync({
  serverConfig: {
    baseUrl: 'https://facile-sayer-worlds.ping-devops.com',
    wellknown: 'https://facile-sayer-worlds.ping-devops.com/.well-known/openid-configuration',
  },
...
const authorize = async (code, state) => {
   ...
   */
  await forgerock.TokenManager.getTokens({ query: { code, state }, login: 'redirect' });
